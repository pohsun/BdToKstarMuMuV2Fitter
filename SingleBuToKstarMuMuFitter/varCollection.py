...
Bmass = RooRealVar("Bmass","#font[132]{#font[12]{m}(K_{S}^{0}#pi^{+}#mu^{+}#mu^{#font[122]{\55}})} [GeV]", 4.50, 6.00)
...
Mumumass = RooRealVar("Mumumass", "#font[132]{#font[12]{m}_{#mu^{+}#mu^{#font[122]{\55}}}} [GeV]", 0., 10.)
Mumumasserr = RooRealVar("Mumumasserr", "Error of #font[132]{#font[12]{m}_{#mu^{+}#mu^{#font[122]{\55}}}} [GeV]", 0., 10.)
Kstarmass = RooRealVar("Kstarmass", r"#font[132]{#font[12]{m}_{K^{*}}} [GeV]", 0, 1.5)
Kshortmass = RooRealVar("Kshortmass", r"#font[132]{#font[12]{m}_{K_{S}}} [GeV]", 0.427, 0.577)
Lambdamass = RooRealVar("Lambdamass", r"#font[132]{#font[12]{m}_{p#pi}} [GeV]", 1., 1.5)
Lambdabmass = RooRealVar("Lambdabmass", "#font[132]{#font[12]{m}_{p#pi#mu^{+}#mu^{#font[122]{\55}}}} [GeV]", 4.50, 6.0)
