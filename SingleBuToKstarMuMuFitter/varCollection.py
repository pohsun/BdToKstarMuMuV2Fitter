...
Mumumass = RooRealVar("Mumumass", "#font[132]{#it{m}_{#mu^{+}#mu^{#font[122]{\55}}}} [GeV]", 0., 10.)
Mumumasserr = RooRealVar("Mumumasserr", "Error of #font[132]{#it{m}_{#mu^{+}#mu^{#font[122]{\55}}}} [GeV]", 0., 10.)
Kstarmass = RooRealVar("Kstarmass", r"#font[132]{#it{m}_{K^{*}}} [GeV]", 0, 1.5)
Kshortmass = RooRealVar("Kshortmass", r"#font[132]{#it{m}_{K_{S}}} [GeV]", 0.427, 0.577)
Lambdamass = RooRealVar("Lambdamass", r"#font[132]{#it{m}_{p#pi}} [GeV]", 1., 1.5)
Lambdabmass = RooRealVar("Lambdabmass", "#font[132]{#it{m}_{p#pi#mu^{+}#mu^{#font[122]{\55}}}} [GeV]", 4.50, 6.0)
Q2 = RooRealVar("Q2", r"#font[12]{q^{2}} [GeV^{2}]", 0.5, 20.) # Copy the title to anaSetup.py to sync latexLabel in bins
...
genCosThetaK = RooRealVar("genCosThetaK", r"cos #font[132]{#it{#theta}_{K}}", -1., 1.)
genCosThetaL = RooRealVar("genCosThetaL", r"cos #font[132]{#it{#theta}_{#it{l}}}", -1., 1.)
